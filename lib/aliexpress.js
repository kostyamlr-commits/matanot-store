...
export const CATEGORIES = {
  wtf:    ['weird statue figurine','bizarre gift unique','strange oddity decor'],
  gadget: ['creative office gadget','magnetic floating desk','desktop fountain unique'],
  funny:  ['funny gag gift','prank trick toy','weird desk toy'],
